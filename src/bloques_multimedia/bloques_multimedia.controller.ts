...
export class BloquesMultimediaController {
  constructor(private readonly bloquesMultimediaService: BloquesMultimediaService) {}
  ...
  @Patch(':id')
  update(@Param('id') id: string, @Body() updateBloquesMultimediaDto: UpdateBloquesMultimediaDto) {
    return this.bloquesMultimediaService.update(+id, updateBloquesMultimediaDto);
  }
